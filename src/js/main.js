...
// const slidePlaceholder = (idx) => {
//   // $('.company-work__placeholder').css('top', '0');
//   console.log(idx);
//   // setTimeout(() => {
//   //   // $('.company-work__placeholder').css('top', '100%');

//   //   // $('.company-work__image img').removeClass('focus');
//   //   // $('.company-work__image img')
//   //   //   .eq(parseInt(idx - 1))
//   //   //   .addClass('focus');
//   // }, 200);
// };

// const workSection = $('.company-work');
// if (workSection.length !== 0) {
//   const workSectionTop = workSection.offset().top;
//   const workSectionHeight = workSection.outerHeight();

//   const workItem = $('.company-work__item');
//   const workItemHeight = parseInt(workItem.css('height'));
//   const workItemLenght = workItem.length;

//   let pos = 0;
//   const step = 300;

//   workSection.css('height', workSectionHeight + step * workItemLenght);
//   if (workSection.length !== 0) $('.wrapper').css('overflow', 'unset');

//   $(window).scroll(function () {
//     const scrolled = $(window).scrollTop();
//     const versus = scrolled - workSectionTop;

//     console.log(scrolled, workSectionTop + step * workItemLenght);

//     if (scrolled >= workSectionTop && scrolled <= workSectionTop + step * workItemLenght) {
//       if (versus > step * 5) {
//         pos = workItemHeight * 4;
//       } else if (versus > step * 4) {
//         pos = workItemHeight * 4;
//       } else if (versus > step * 3) {
//         pos = workItemHeight * 3;
//       } else if (versus > step * 2) {
//         pos = workItemHeight * 2;
//       } else if (versus > step) {
//         pos = workItemHeight;
//       } else {
//         pos = 0;
...
//       // console.log(versus, step);

//       $('.company-work__scroll').css('transform', 'translate3d(0, -' + pos + 'px, 0)');
//     }
//   });
// }
